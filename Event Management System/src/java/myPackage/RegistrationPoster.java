...
public class RegistrationPoster extends HttpServlet{
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException 
    {
        ...
        try {
            ...
            String sql = "INSERT INTO `register_poster`(`first_name`, `last_name`,`course`, `email`, `institute_name`) VALUES ('"+fname+"','"+lname+"','"+course+"','"+email+"','"+iname+"')";
